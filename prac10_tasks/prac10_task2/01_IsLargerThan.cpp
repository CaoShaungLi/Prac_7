...
int main()
{
	...
	cout<< "stateless lambda" << endl;
	auto isLargerThan {[] (int value1, int value2) {return value1 > 100 && value2 > 100;}};
	findMatches(values1, values2, isLargerThan, printMatch);

	cout<< "\nstateful lambda" << endl;
	int threshold = 100;
	auto isLargerThan2 {[threshold] (int value1, int value2) {return value1 > threshold && value2 > threshold;}};
	findMatches(values1, values2, isLargerThan2, printMatch);
